...
@ExampleDefinition()
class XabcdAnnotationCreationModifierFragment : SingleChart2DFragment() {
    override fun initExample(surface: SciChartSurface) {}

    fun addXabcdAnnotationCreationModifier(surface: SciChartSurface) {
        // <AddXabcdAnnotationCreationModifier>
        // Create an XabcdAnnotationCreationModifier
        val xabcdCreationModifier = XabcdAnnotationCreationModifier().apply {
        ...
        surface.chartModifiers.add(xabcdCreationModifier)
        // </AddXabcdAnnotationCreationModifier>
    }

    // <CustomXabcdAnnotationCreationModifier>
    // Define a custom XabcdAnnotationCreationModifier
    private class CustomXabcdAnnotationCreationModifier : XabcdAnnotationCreationModifier() {
    ...
    fun useCustomXabcdAnnotationCreationModifier(surface: SciChartSurface) {
