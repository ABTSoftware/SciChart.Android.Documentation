package com.scichart.docsandbox.examples.java

import com.scichart.docsandbox.examples.java.annotationsAPIs.*
import com.scichart.docsandbox.examples.java.axis3DAPIs.Axis3DAPIs
import com.scichart.docsandbox.examples.java.axisAPIs.AxisAPIs
import com.scichart.docsandbox.examples.java.chartModifier2D.ChartModifier2D
import com.scichart.docsandbox.examples.java.chartModifier3D.ChartModifier3D
import com.scichart.docsandbox.examples.java.series2d.*

val ExamplesJava = listOf<Class<*>>(
    // region series2D
